...
```bash
vulpineos remote tui --url https://your-server:8443 --api-key YOUR_KEY
```
...
```bash
./vulpineos remote --url https://your-server:8443 --api-key YOUR_KEY
# or explicitly:
./vulpineos remote panel --url https://your-server:8443 --api-key YOUR_KEY
```
