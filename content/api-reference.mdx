...
| `GET` | `/v1/mobile/devices` | Yes | List Android and iOS devices visible to the bridge host |
| `GET` | `/v1/mobile/devices/{platform}/{id}/targets` | Yes | List inspectable targets for a device |
| `GET` | `/v1/mobile/sessions` | Yes | List attached mobile sessions |
...
Completed or interrupted transcript event history remains queryable after API restarts.
