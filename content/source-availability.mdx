...
|---------|------------------|
| Vulpine API | Hosted extraction API, authenticated and visual workflows, browser audio and mobile endpoints, recurring monitors, billing, API keys, and dashboard backend |
