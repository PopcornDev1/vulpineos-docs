# <img src="/VulpineOSLogo.png" alt="" width="32" height="32" style={{verticalAlign: "middle", marginRight: "10px"}} />MCP Tools

VulpineOS provides a [Model Context Protocol](https://spec.modelcontextprotocol.io/) (MCP) server that exposes browser automation as tool calls. OpenClaw agents use these tools to browse — every action goes through Camoufox.
