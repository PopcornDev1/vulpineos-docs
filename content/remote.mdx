...
```bash
./vulpineos serve --host 0.0.0.0 --port 8443 --api-key YOUR_SECRET_KEY
```
...
```bash
./vulpineos remote --url https://your-vps:8443 --api-key YOUR_SECRET_KEY
# or explicitly:
./vulpineos remote panel --url https://your-vps:8443 --api-key YOUR_SECRET_KEY
```
...
```bash
./vulpineos remote tui --url https://your-vps:8443 --api-key YOUR_SECRET_KEY
```
...
- Always use `wss://` / `https://` (TLS) in production
