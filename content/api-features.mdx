...
| Audio workflows | `GET /v1/audio/captures`, `POST /v1/audio/captures`, `GET /v1/audio/captures/{id}/chunk`, `POST /v1/audio/captures/{id}/stop`, `POST /v1/audio/captures/{id}/transcription/start`, `POST /v1/audio/captures/{id}/transcription/stop`, `GET /v1/audio/captures/{id}/transcription/events` | Available with paid/private wiring |
| Mobile workflows | `GET /v1/mobile/devices`, `GET /v1/mobile/devices/{platform}/{id}/targets`, `GET /v1/mobile/sessions`, `POST /v1/mobile/sessions`, `DELETE /v1/mobile/sessions/{id}`, `POST /v1/mobile/sessions/{id}/targets`, `POST /v1/mobile/sessions/{id}/recording/start`, `POST /v1/mobile/sessions/{id}/recording/stop`, `GET /v1/mobile/recordings/{id}/content` | Available with bridge support |
