...
|------|-----------|--------|
| Extraction | `POST /v1/extract`, `POST /v1/extract/authenticated`, `GET /v1/auth/sessions`, `DELETE /v1/auth/sessions/{name}`, `POST /v1/visual`, `POST /v1/batch` | Available in the API service |
